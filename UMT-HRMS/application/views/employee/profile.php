                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="<?php echo $emp_leave_balance; ?>" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(function () {
        ...
        $(".file-input-ajax").fileinput({
            uploadUrl: '<?php echo base_url(); ?>employee/profile/upload_avatar', // server upload action
            uploadAsync: true,
            maxFileCount: 1,
            maxFileSize: 5096,
            initialPreview: [],
    ...
    function change_password()
    {
        ...
        $.ajax({
            type: 'POST',
            async: false,
            url: '<?php echo base_url(); ?>employee/Profile/change_password/',
            data: {
                'password': password,
                'cpassword': cpassword
